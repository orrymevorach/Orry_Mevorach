...
export default function About() {
  return (
    <Section classNames="section-general section-about" id="about">
      <div className="section-container section-about-container">
        <div className="content-container">
          ...
          <div className="text-container">
            <h2>About Me</h2>
            <p>
              Hello! My name is Orry Mevorach and I am a front-end web
              developer. I love tackling problems, and learning new ways to
              problem solve.
            </p>
            <p>
              ...
              aesthetic. In other words, I appreciate a site that is easy to
              use, nice to look at, fun to click on, and all-around
